...
public class AudioManager
{
    ...
    public void PlayBGM(BGMType type)
    {
        ...
        {
            Debug.LogWarning($"[AudioManager] BGM clip が未設定です: {type}");
            return;
        }
        ...
        if (source == null)
        {
            Debug.LogError("[AudioManager] BGMSource が未設定です。");
            return;
        }
    ...
    public void StartLoopSE(SEType type)
    {
        ...
        if (entry == null || entry.clip == null)
        {
            Debug.LogWarning($"[AudioManager] SE clip が未設定です: {type}");
            return;
        }
        ...
        if (source == null)
        {
            Debug.LogError("[AudioManager] LoopSESource が未設定です。");
            return;
        }
    ...
    public void PlaySE(SEType type)
    {
        ...
        if (source == null)
        {
            Debug.LogError("[AudioManager] SESource が未設定です。");
            return;
        }
